...
public class SharePictureTab extends Fragment implements View.OnClickListener
{
    ...
    private EditText editImgDescription;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        editImgDescription = view.findViewById(R.id.editImgDescription);
            ...
            case R.id.imgShare:
                ...
                break;
                 ...
                 case R.id.btnShareImg:
                     ...
                     {
                         if (editImgDescription.getText().toString().equals(""))
                         {
                             FancyToast.makeText(getContext(), "Error: You update a description",
                         ...
                         else
                         {
                             ...
                             parseObject.put("image_des", editImgDescription.getText().toString());
                             ...
                             parseObject.saveInBackground(new SaveCallback()
                             {
                                 ...
                                 public void done(ParseException e)
                                 {
                                     if (e == null)
                                     {
                                         FancyToast.makeText(getContext(), "Image uploaded to server successfully.",
                     ...
                     {
                         FancyToast.makeText(getContext(), "Error: You must load an image",
                                 FancyToast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                     }
